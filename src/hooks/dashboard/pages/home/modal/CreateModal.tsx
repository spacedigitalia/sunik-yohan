            ...
            <DialogContent className="sm:max-w-4xl max-h-full md:max-h-[90vh] overflow-y-auto bg-white dark:bg-gray-900 rounded-none md:rounded-xl shadow-2xl border-0">
                ...
                <form onSubmit={handleSubmit}>
                    <div className="grid gap-4 sm:gap-6 py-4 px-0 md:px-6">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                            <div className="space-y-2">
                                <Label htmlFor="buttonLabel" className="flex items-center gap-2 text-sm sm:text-base text-gray-700 dark:text-gray-300">
                                    <Type className="h-4 w-4" />
                                    Button Label
                                </Label>
                                <Input
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="buttonHref" className="flex items-center gap-2 text-sm sm:text-base text-gray-700 dark:text-gray-300">
