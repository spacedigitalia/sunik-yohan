            ...
            <div>
                <div className="container px-4 py-12">
                    <div className="text-center max-w-2xl mx-auto">
                        ...
                        <h2 className="text-3xl font-bold text-gray-800 mb-4">Tidak Ada Transaksi</h2>
                        <p className="text-gray-600 text-lg mb-8">Anda tidak memiliki transaksi apa pun saat ini.</p>
                        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                            <div className="flex items-center justify-center gap-3 text-gray-500">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                    <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clipRule="evenodd" />
                                </svg>
                                <p className="text-sm">Riwayat transaksi Anda akan muncul di sini setelah Anda memiliki pesanan</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section>
            ...
            <div className="flex gap-6 items-center mb-6">
                <div className="flex items-center gap-2 bg-blue-50 px-4 py-2 rounded-lg">
                    ...
                    <p className="text-gray-700 font-medium">Total Transaksi: <span className="text-blue-600 font-bold">{transactions.length}</span></p>
                </div>
                ...
                <div className="flex items-center gap-2 bg-green-50 px-4 py-2 rounded-lg">
                    ...
                    <p className="text-gray-700 font-medium">Subtotal: <span className="text-green-600 font-bold">{formatPriceWithSymbol(transactions.reduce((sum: number, transaction: ExtendedTransactionData) => sum + Number(transaction.totalAmount), 0).toString())}</span></p>
                </div>
            </div>
                        ...
                        <div className="flex flex-col gap-6">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    ...
                                    <PaymentModal transaction={transaction} />
                                </div>
                            </div>
                        </div>
                    </Card>
