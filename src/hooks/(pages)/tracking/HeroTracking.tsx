        ...
        <div className="relative h-[50vh] sm:h-[65vh] overflow-hidden">
            ...
            >
                ...
                <motion.div
                    ...
                    style={{ opacity }}
                >
                    <h3 className='text-4xl md:text-6xl font-bold text-title tracking-tight'>Order Tracking</h3>
                    <div className="flex items-center gap-3 bg-[#000000]/20 px-6 py-2.5 rounded-full backdrop-blur-md">
                        ...
                        <span className='text-sm md:text-base text-white/90'>Order Tracking                        </span>
                    </div>
                </motion.div>
            </motion.div>
        </div>
